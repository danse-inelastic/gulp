...
public class Interpolation extends TitledPanel {
	...
	private final JTextField txtPotentialInterpolation = new JTextField();

	private final JLabel lblUse = new JLabel("use");
	private final JLabel lblInterpolationPoints = new JLabel("interpolation points");
	private final JLabel lblAccelerate = new JLabel("(i.e. 100000) to accelerate the calculation");
