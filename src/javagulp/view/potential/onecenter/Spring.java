...
public class Spring extends PotentialPanel implements Serializable {
	...
	private final PPP k2 = new PPP("<html>k<sub>2</sub> (eV/&Aring;<sup>2</sup>)</html>");
	private final PPP k4 = new PPP("<html>k<sub>4</sub> (eV/&Aring;<sup>4</sup>)</html>");

	private final JTextField txtCutoffDistance = new JTextField("0.6");

	private final TitledPanel pnlCoreShell = new TitledPanel();

	//	private JComboBox cboUnits = new JComboBox(new DefaultComboBoxModel(
	//			new String[] {"kjmol", "kcal"}));

	//	private JLabel lblUnits = new JLabel("units");
	private final JLabel lblCutoffDistnce = new JLabel("<html>(&Aring;)</html>");
	private final JLabel lblSpringEq = new JLabel("<html>E = 1/2 k<sub>2</sub>r<sup>2</sup> + 1/24 k<sub>4</sub>r<sup>4</sup></html>");
