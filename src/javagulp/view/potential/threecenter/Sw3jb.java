...
public class Sw3jb extends PotentialPanel implements Serializable {
	...
	private final PPP q = new PPP(g.html("Q (eV)"));

	private final JLabel lblUnits = new JLabel("units");
	private final JLabel lblImage = new JLabel(new CreateIcon().createIcon("angleNum.png"));
	private final JLabel lblThreeBodyEq = new JLabel(g.html("E = k F<sub>12</sub> F<sub>13</sub> exp(" + g.rho
