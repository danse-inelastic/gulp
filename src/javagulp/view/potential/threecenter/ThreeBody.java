...
public class ThreeBody extends PotentialPanel implements Serializable {
	...
	private final PPP k3 = new PPP(g.html("k<sub>3</sub>&nbsp;(eV&nbsp;rad<sup>-3</sup>)"));
	private final PPP k4 = new PPP(g.html("k<sub>4</sub>&nbsp;(eV&nbsp;rad<sup>-4</sup>)"));
	...
	public PotentialPanel clone() {
		getParams();
		final ThreeBody t = new ThreeBody();
