...
class TwoDCellVectors extends JPanel {
	...
	private final JTextField txtAX = new JTextField();
	private final JTextField txtAY = new JTextField();
	private final JTextField txtBX = new JTextField();
	private final JTextField txtBY = new JTextField();

	private final JLabel lblAV = new JLabel(g.html("a (" + g.ang + ")"));
	private final JLabel lblBV = new JLabel(g.html("b (" + g.ang + ")"));
	...
	public String writeSvectors() throws IncompleteOptionException {
		final JTextField[] fields = { txtAX, txtAY, txtBX, txtBY };
		final String[] descriptions = { "ax cell vector", "ay cell vector",
